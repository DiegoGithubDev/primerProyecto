...
class Gestion extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('gestionName', 'length', 'max'=>100),
			array('fechaInicio, fechaFin', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, fechaInicio, fechaFin, gestionName', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'inscripcions' => array(self::HAS_MANY, 'Inscripcion', 'fkGestion'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('gestionName',$this->gestionName,true);
